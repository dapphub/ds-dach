...
#Cheque type data
cheque_TYPEHASH=$(seth keccak $(seth --from-ascii "Cheque(address sender,address receiver,uint256 amount,uint256 fee,uint256 nonce,uint256 expiry,address relayer)"))
