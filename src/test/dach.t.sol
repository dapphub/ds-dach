...
contract DachTest is DSTest, ChaiSetup, UniswapSetup {
    ...
    function setUp() public {
      super.setUp();
      dach = new Dach(address(dai), address(uniswap), address(chai), 99);
    }
    ...
    function test_dai_address() public {
        ...
        assertEq(address(dai), address(0x0F1c6673615352379AFC1a60e3D0234101D67eb2));
    }
    ...
    function test_swap() public {
      ...
      assertEq(dach.nonces(ali),0);
      dai.approve(address(uniswap), uint(-1));
      uniswap.addLiquidity.value(1000000000)(0, 20, uint(-1));
